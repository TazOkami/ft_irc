...
struct Server {
    ...
    void h_NOTICE(int fd, const std::vector<std::string>& params, const std::string& trailing); // NEW
    ...
    void h_TOPIC(int fd, const std::vector<std::string>& params, const std::string& trailing);
